              ...
              <q-form class="login-form" @submit="authenticate">
                ...
                <div class="row items-center q-mt-xl">
                  ...
                  <div class="col-md col-sm col-xs-12">
                    <div class="row forgot-password" :class="$q.screen.lt.sm ? 'justify-center q-mt-xl' : 'justify-end'">
                      <a href="https://landa-sme.ir/account/forgetpassword"
                        class="text-primary text-weight-bold no-letter-spacing">{{ $t("login-page.forgot-password") }}</a>
                    </div>
                  </div>
                </div>
              </q-form>
