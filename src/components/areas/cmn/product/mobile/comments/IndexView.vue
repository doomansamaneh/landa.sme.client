          ...
          <template #default>
            <q-card class="bordered-1 no-shadow q-ml-sm">
              ...
              <q-card-section v-if="item.commentValue" class="q-pt-none">
                <p class="text-caption line-height-xs no-letter-spacing" contenteditable="true" v-show="!editCommentBtn">
                  {{ item.comment }}
                </p>
                ...
                <div v-if="!editCommentBtn" class="row justify-start">
                  <q-btn @click="editComment" padding="4px 12px" unelevated rounded class="text-on-dark text-body3">
                    <q-icon name="o_edit" size="xs" class="q-mr-sm" />
                    <span>ویرایش</span>
                  </q-btn>
                  <q-btn @click="deleteAlert" padding="4px 12px" unelevated rounded class="text-on-dark text-body3">
