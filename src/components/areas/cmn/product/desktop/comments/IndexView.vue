  ...
  <div :style="margin">
    ...
    <div class="row">
      <div class="col-md-9 col-sm-12 col-xs-12">
        ...
        <q-btn @click="saveComment" flat rounded class="bg-primary text-white q-mt-md">
      ...
      <q-timeline color="accent">
        <q-timeline-entry avatar="https://cdn.quasar.dev/img/avatar4.jpg" v-for="item in items" :key="item">
          <template #default>
            <div class="row">
              <div class="col-md-9 col-sm-12 col-xs-12">
                <q-card class="bordered-1 no-shadow q-ml-xl q-pa-md" :class="{ 'q-mr-md': $q.screen.gt.sm }">
