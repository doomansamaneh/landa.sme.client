...
<script setup>
  ...
  import { useCustomerAccountGrid } from "src/components/areas/acc/_composables/useCustomerAccountGrid";

  import ToolbarDesktop from "components/shared/ToolBarDesktop.vue";
  import ToolbarMobile from "components/shared/ToolBarMobile.vue";
  import Desktop from "../desktop/CustomerAccount.vue";
  ...
  const title = t("main-menu-items.Acc_Report_CustomerAccounting");
