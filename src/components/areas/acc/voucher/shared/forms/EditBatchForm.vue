      ...
      >
        ...
        <div class="col-md-3 col-sm-3 col-xs-12">
          <q-checkbox
            dense
            size="46px"
            v-model="formStore.editBatchModel.value.invoiceType.isModified"
            label="اصلاح شود؟"
          />
        </div>
      </div>
      ...
      >
        ...
        <div class="col-md-3 col-sm-3 col-xs-12">
          <q-checkbox
            dense
            size="46px"
            v-model="formStore.editBatchModel.value.contract.isModified"
            label="اصلاح شود؟"
          />
        </div>
      </div>
      ...
      >
        ...
        <div class="col-md-3 col-sm-3 col-xs-12">
          <q-checkbox
            dense
            size="46px"
            v-model="formStore.editBatchModel.value.customer.isModified"
            label="اصلاح شود؟"
          />
        </div>
      </div>
