<template>
  ...
  <template v-if="!edit">
      ...
      <q-menu class="border-radius-xl" :offset="[0, 20]" fit>
        <q-list dense padding>
          ...
          <q-item clickable v-close-popup tabindex="0">
            <div class="q-py-sm">
              <q-item-section avatar>
                <q-avatar class="bg-on-dark" size="sm"><q-icon name="o_phone_android" size="16px" /></q-avatar>
              </q-item-section>
            </div>
            <q-item-section>
          ...
          <q-item clickable v-close-popup tabindex="0">
            <div class="q-py-sm">
              <q-item-section avatar>
                <q-avatar class="bg-on-dark" size="sm"><q-icon name="o_public" size="16px" /></q-avatar>
              </q-item-section>
            </div>
            <q-item-section>
    ...
    <div class="q-my-lg">
      <div class="row">
        <div class="col">
          <q-item-label class="text-body2 no-letter-spacing caption-on-dark q-mb-sm">تلفن</q-item-label>
  ...
  <template v-else>
    ...
    <div class="q-mt-md">
      <q-checkbox size="46px" class="q-mb-sm text-body2 no-letter-spacing" dense v-model="main" val="main"
        label="اصلی" />
    </div>

    <div class="row items-center q-gutter-x-sm q-my-lg">
      <q-btn color="primary" unelevated rounded class="primary-shadow text-body2 no-letter-spacing" label="ذخیره"
        @click="save" />
      <q-btn unelevated rounded class="text-body2 no-letter-spacing" label="انصراف" @click="edit = false" />
    </div>
