    ...
    <div class="col-md-8 col-sm-12 col-xs-12">
      <div class="row q-col-gutter-md">
        <div class="col-md-6 col-sm-12 col-xs-12">
          ...
          <customer-lookup autofocus v-model:selectedId="localFormStore.model.value.customerId"
        ...
        <div class="col-md-4 col-sm-12 col-xs-12">
          ...
          <sale-type-lookup v-model:selectedId="localFormStore.model.value.typeId"
            v-model:selectedText="localFormStore.model.value.typeTitle" :filterExpression="filterExpression" />
        </div>
            ...
            <div class="q-mt-md q-mb-md" v-show="moreInfo">
              <div class="row q-col-gutter-md">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <custom-input hide-bottom-space v-model="localFormStore.model.value.comment" type="textarea" />
                </div>
              </div>
              ...
              <div class="row q-col-gutter-x-md">
                <div class="col-md-6 col-sm-12 col-xs-12 q-mt-md">
                  ...
                  <contract-lookup v-model:selectedId="localFormStore.model.value.contractId" v-model:selectedText="localFormStore.model.value.contractTitle
            " />
                </div>

                <div class="col-md-6 col-sm-12 col-xs-12 q-mt-md">
                  <q-item-label caption class="q-mb-sm">بازاریاب</q-item-label>
                  <customer-lookup v-model:selectedId="localFormStore.model.value.contactId" v-model:selectedText="localFormStore.model.value.contactName
            " />
                </div>
              </div>
              ...
              <div class="row q-col-gutter-md">
                <div class="col-md-6 col-sm-12 col-xs-12 q-mt-md">
                  ...
                  <inventory-lookup v-model:selectedId="localFormStore.model.value.inventoryId
            " v-model:selectedText="localFormStore.model.value.inventoryTitle
            " />
                </div>
              </div>
            </div>
      ...
      <div class="row justify-end" :class="{'q-mt-md' : $q.screen.xs}">
        <div class="col-md-6 col-sm-12 col-xs-12">
          ...
          <q-input type="number" hide-bottom-space v-model="localFormStore.model.value.no" outlined dense
            ...
            <template #append>
              <q-icon size="sm" :name="invoiceNo ? 'o_no_encryption' : 'o_lock'"
                class="cursor-pointer all-pointer-events" @click="toggleInvocieNo" />
            </template>
          </q-input>
        </div>
      </div>
