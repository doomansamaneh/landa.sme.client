<template>
  ...
  <div class="print-hide">
    ...
    <tbody>
      ...
      <tr>
        <td style="padding: 40px 6px;" :style="borderColor_()" class="text-body2 no-letter-spacing">
          مهر و امضا فروشنده
        </td>
        <td style="padding: 40px 6px;" :style="borderColor_()" class="text-body2 no-letter-spacing">مهر و امضا
          خریدار</td>
      </tr>
    </tbody>
  </table>
