<template>
  <q-card class="bordered">
    <q-card-section class="row items-center justify-between">
      <q-toggle dense size="40px" class="text-body2 no-letter-spacing" v-model="value"
        label="نمایش موجودی صفر" left-label />
      <q-btn @click="expanded = !expanded" padding="6px 12px" rounded unelevated dense
