  ...
  <template v-if="dense">
    <div>
      <q-btn round dense unelevated>
        <q-icon size="24px" name="more_vert" />
        <q-menu
          style="width: 200px"
        ...
        >
          <q-list>
            <q-item clickable @click="tableStore?.reloadData">
            ...
            <q-item clickable @click="tableStore?.toggleFullscreen">
              <q-item-section avatar>
                <q-avatar size="32px">
                  <q-icon size="24px" name="o_fullscreen" />
                </q-avatar>
              </q-item-section>
            ...
            <q-item clickable @click="tableStore?.toggleDense">
              <q-item-section avatar>
                <q-avatar size="32px">
                  <q-icon size="24px" name="o_height" />
                </q-avatar>
              </q-item-section>
            ...
            <q-item clickable @click="tableStore?.toggleFontSize">
              <q-item-section avatar>
                <q-avatar size="32px">
                  <q-icon size="24px" name="o_format_size" />
                </q-avatar>
              </q-item-section>
              ...
              <q-item-section>
                <div class="text-body2 no-letter-spacing">
                  <template
                    v-if="tableStore?.tdFontSize.value === 13"
                  >
                    فونت معمولی
                  </template>
            ...
            <q-item clickable @click="tableStore?.toggleSeparator">
              <q-item-section avatar>
                <q-avatar size="32px">
                  <q-icon size="24px" name="o_format_underlined" />
                </q-avatar>
              </q-item-section>
              ...
              <q-item-section>
                <div class="text-body2 no-letter-spacing">
                  <template
                    v-if="tableStore?.separator.value === 'none'"
                  >
                    خط‌ دار
                  </template>
            ...
            <q-item clickable @click="tableStore?.print">
              <q-item-section avatar>
                <q-avatar size="32px">
                  <q-icon size="24px" name="o_print" />
                </q-avatar>
              </q-item-section>
            ...
            <q-item clickable>
              <q-item-section avatar>
                <q-avatar size="32px">
                  <q-icon size="24px" name="o_download" />
                </q-avatar>
              </q-item-section>
      ...
      <div class="flex items-center q-gutter-xs">
        ...
        >
          <q-icon
            size="21px"
            :name="
              tableStore?.dense.value ? 'o_height' : 'o_zoom_in_map'
            "
          />
          <q-tooltip
            :delay="700"
        ...
        >
          ...
          <q-tooltip
            ...
            class="custom-tooltip"
            :anchor="
              tableStore?.separator.value
                ? 'bottom end'
                : 'bottom middle'
            "
            :self="
              tableStore?.separator.value ? 'top end' : 'top middle'
            "
          >
            <div class="text-body2 no-letter-spacing">
