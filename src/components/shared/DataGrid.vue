<template>
    <q-table row-key="id" :card-class="color" card="blue" color="green" bordered flat :loading="loading" :rows="rows"
        :title="title" v-model:pagination="pagination" :rows-per-page-options="[5, 10, 25, 50, 100]"
        @request="onRequest" binary-state-sort :columns="columns"
