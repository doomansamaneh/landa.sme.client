  ...
  <q-card class="change-password-card">
    ...
    <q-card-section>
      <q-form ref="form">
        ...
        <q-input outlined v-model="confirmNewPassword" :type="isPwdConfirmPassword ? 'password' : 'text'" :placeholder="
    ...
    <q-card-actions class="q-gutter-sm q-pa-md dark-1">
      <q-btn type="submit" @click="submitForm" color="light-blue-6" unelevated no-caps padding="5px 16px"
